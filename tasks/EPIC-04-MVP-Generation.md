...
Verified: `pytest` covers HITL approve/changes/reject/owner check, planner idempotency, markdown/JSON export, website end-to-end smoke, estimate math, mocked owner notify on TZ ready, factory gate, `in_mvp` slice, sealed secrets, stub executor, send-to-client.
