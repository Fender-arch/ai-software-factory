...
WELCOME_CREATE_RU = (
    "Привет — это интервью по «{name}».\n\n"
    "Сначала познакомимся, потом разберём задачу. Есть бриф — киньте файл. "
    "Нет — проговорим.\n\n"
    "Текст, голос или кнопки. В конце соберём ТЗ. «Пауза», если надо отойти."
)
