...
WELCOME_CREATE_RU = (
    "Добро пожаловать. Это сбор требований для проекта «{name}».\n\n"
    "Я как консультант: сначала познакомимся — как к вам обращаться, "
    "контакты, компания или физлицо, сфера. Потом спрошу, есть ли уже "
    "готовая постановка или бриф: если да — прикрепите файл, разберём "
    "и дополним; если нет — пройдём задачу в разговоре.\n\n"
